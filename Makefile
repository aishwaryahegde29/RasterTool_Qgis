...
SOURCES = \
	__init__.py \
	RasterTool.py RasterTool_dialog.py

PLUGINNAME = RasterTool

PY_FILES = \
	__init__.py \
	RasterTool.py RasterTool_dialog.py

UI_FILES = RasterTool_dialog_base.ui
...
QGISDIR=C:\Users\applied\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
